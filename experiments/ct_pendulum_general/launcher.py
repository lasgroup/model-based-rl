...
general_configs = {
    'project_name': ['CT_PendulumGeneralPredictDiffFix_June21_17_00'],
    ...
    'regression_model': ['probabilistic_ensemble', 'deterministic_ensemble', 'deterministic_FSVGD', 'probabilistic_FSVGD'],
    'beta': [2.0],
    'weight_decay': [0.0],
}
