...
from mbrl.model_based_agent.system_wrapper import ContinuousPetsSystem, ContinuousPetsDynamics
...
class PETSModelBasedAgent(BaseModelBasedAgent):
    ...
    def prepare_actor(self,
        ...
        # Note probably only one of the Dynamics and System has to change
