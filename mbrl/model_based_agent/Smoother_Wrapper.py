...
def smoother_wrapper(agent,
    ...
    # Add the simulate_on_true_env function to the agent
    agent.simulate_on_true_env = types.MethodType(simulate_on_true_env, agent)
    agent._get_dx = types.MethodType(_get_dx, agent)
    agent._split_transitions = types.MethodType(_split_transitions, agent)
