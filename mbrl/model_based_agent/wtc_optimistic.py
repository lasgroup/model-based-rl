...
from mbrl.model_based_agent.system_wrapper import WtcScOptimisticDynamics, WtcScOptimisticSystem
...
class WtcOptimistic(WtcBaseModelBasedAgent):
    ...
    def prepare_actor(self,
        ...
        dynamics, system, actor = WtcScOptimisticDynamics, WtcScOptimisticSystem, OptimisticActor
